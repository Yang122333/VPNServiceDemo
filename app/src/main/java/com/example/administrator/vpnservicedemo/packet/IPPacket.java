...
public class IPPacket extends Packet {
    ...
    public static final int TCP_ID = 6;
    public static final int IP_LENGTHS = 4;
    ...
    public int getLength(int offset) {
        return ((data[offset + IP_LENGTH] & 0xff) << BYTE_LENGTH) | (data[offset + IP_LENGTH + 1] & 0xff);
    }
